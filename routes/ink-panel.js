...
router.get("/panel", (req, res) => {
  ...
  res.render(
    ...
    marco({
      ...
      // Si el reto está recibiendo inscripciones ahora mismo. Se decide en
      // config, no en esta pantalla, así que hay que decirlo o alguien va a
      // buscar el interruptor un buen rato.
      abierta: eventos.inscripcionesAbiertas("inkreible"),
      aviso: req.query,
    })
  );
});
