...
//
// Los estados con `libera` no cuentan, y de ahí sale la salida para el caso
// contrario —el que sí cambió de idea y tiene que volver a radicar—: cancelar
// su proyecto le devuelve el cupo sin borrarle el rastro de que existió.
 ...
 *
 * Se promedian SOLO los que tienen nota, igual que las calificaciones de
 * reunión: un objetivo sin calificar no vale cero, vale que todavía no se
 * miró. Contar los pendientes como ceros en octubre daría un promedio de 1.2
 * que no significa nada y que además baja solo con que el semestre avance.
 *
