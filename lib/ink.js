...
// La edición no se abre desde aquí ni desde el panel: la siembra
// db/database.js al arrancar, una por semestre, con los valores de config.INK.
// El semestre lo dice config.PERIODO y nadie más, que es la regla del sitio
// entero. Lo que sí se toca desde el panel es lo de adentro —el cronograma, la
// carpeta, el cupo—, y para eso están las herramientas de la sala de control.
