...
const VACIO = {
  ...
  requisitos: null,
  patrocinadores: null,
  // Virtual Champions: su página se arma con la base (equipos, bracket,
  // marcador), pero el texto que no cambia durante el torneo vive igual en un
  // JSON. Va aquí para que una sección sin escribir no reviente la vista.
  hero: null,
  formato: null,
  reglamento: null,
  premios: null,
  faq: null,
  // Music Fest: el cartel sale de la base, pero el itinerario de la tarde y
  // los textos de las dos puertas se escriben a mano como los de la Expo.
  que_es: null,
  puertas: null,
  normas: null,
};
