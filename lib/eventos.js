...
// El día de hoy en AAAA-MM-DD y en hora local. Con toISOString() la fecha
// saltaría al día siguiente cada tarde (Colombia va cinco horas detrás de UTC)
// y el evento del día cambiaría a las 7 p.m.
function hoy() {
  const d = new Date();
